...
-- Equation(s):
-- \PC_in|sinal_PC~5_combout\ = (!\Controle_ini|Equal0~0_combout\ & (\PC_in|sinal_PC\(2) $ (((\PC_in|sinal_PC\(0) & \PC_in|sinal_PC\(1))))))
...
-- Equation(s):
-- \PC_in|sinal_PC~4_combout\ = (!\Controle_ini|Equal0~0_combout\ & (\PC_in|sinal_PC\(3) $ (((\PC_in|sinal_PC\(2) & \PC_in|Add0~0_combout\)))))
...
-- Equation(s):
-- \Controle_ini|Equal0~0_combout\ = (\MEM_ini|instrucao_atual\(9) & (\MEM_ini|instrucao_atual\(10) & !\MEM_ini|instrucao_atual\(8)))
